...
description: "Documentazione ufficiale di BodyMetrics v1.0.1 — il widget Garmin Connect IQ per il monitoraggio delle metriche corporee."
layout: "docs-home"
version: "v1.0.1"
---

Benvenuto nella documentazione di **BodyMetrics v1.0.1**.
...
**v1.0.1** — 10 maggio 2026 — patch di qualità e UX. Vedi il [Changelog](articles/changelog/) per i dettagli.
